...
<div class="p-5 mb-4 bg-light rounded-3">
  ...
  <div class="accordion-item">
    ...
    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      ...
      <div class="col"> 
     <h5>Formularios</h5>
        <p><strong>1.-</strong><strong>Los formularios</strong> de cada equipo, son la herramienta con la que se genera el reporte del estado actual de la maquina.Se puede acceder a ellos a trav�s de la pagina de <strong>Inicio</strong> con el boton "Reporte"</p>
      </div>
