                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarScrollingDropdown">
                       <!-- <li><a class="dropdown-item" href="#">Item</a></li>
                        ...
                        <li><a class="dropdown-item" href="#">PC 03</a></li>
                         <li>
                            <hr class="dropdown-divider">
                        </li>
		...
		<div class="row">
			<div class="col">
				<!-- *****************************INICIA EL SCRIPT PARA MOSTRAR LA IMAGEN******************************************************************** -->
					...
					<div class="threesixty" style="width:20% height:20%" data-path="../img/pc03/pc{index}.png" data-count="19"></div>


                <!-- *****************************FINALIZA EL SCRIPT PARA MOSTRAR LA IMAGEN******************************************************************** -->
              <div class="table-responsive shadow p-3 mb-5 bg-body rounded">
    <h2 style=" text-align:center;"> Thin Client 03</H2>
