                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarScrollingDropdown">
                       <!-- <li><a class="dropdown-item" href="#">Item</a></li>
                        ...
                        <li><a class="dropdown-item" href="#">PC 07</a></li>
                         <li>
                            <hr class="dropdown-divider">
                        </li>
		...
		<div class="row">
			<div class="col">
				<!-- *****************************INICIA EL SCRIPT PARA MOSTRAR LA IMAGEN******************************************************************** -->
					...
					<div class="threesixty" style="width:20% height:20%" data-path="../img/pc07/pc{index}.png" data-count="1"></div>


                <!-- *****************************FINALIZA EL SCRIPT PARA MOSTRAR LA IMAGEN******************************************************************** -->
              <div class="table-responsive shadow p-3 mb-5 bg-body rounded">
    <h2 style=" text-align:center;"> Thin Client 07</H2>
